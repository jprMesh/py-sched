...
title = raw_input("Schedule Title: ")
numCourses = raw_input("Number of Courses: ")
for iii in range(int(numCourses)):
    courses[iii][0] = raw_input("Course "+str(iii+1)+" title: ")
    courses[iii][1] = raw_input("Course "+str(iii+1)+" color: ")
    ...
    diffTimes = raw_input("How many different times of the day during the week do you have this course? "
                         +"(ex. 10'o'clocks on MTRF and a 2'o'clock on W would be only be '2': ")
    for jjj in range(int(diffTimes)):
        courses[iii][2][jjj][0] = raw_input("Class #"+str(jjj+1)+" start time (integer only. ex. '9'): ")
        courses[iii][2][jjj][1] = raw_input("Class #"+str(jjj+1)+" length in hours (integer only): ")
        courses[iii][2][jjj][2] = raw_input("Days of week for class #"+str(jjj+1)+": (ex. 'MTRF'): ")
